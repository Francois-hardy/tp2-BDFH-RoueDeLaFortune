...
public class Ecran {
    ...
    public static void selectionnePhrase() {
        ...
        String[] objets = {"Objets","UN BAC A /SABLE","UNE PAIRE /DE /LUNETTES","UN ETUI /A /LUNETTES","UN CAHIER /DE /BROUILLON","UNE PAIRE /DE /CISEAUX","UNE /TONDEUSE /ELECTRIQUE","UN KIT DE /REPARATION /VELO","UN SET /DE /COUVERTS","UNE RATION /DE /NOURRITURE","UNE TROUSSE /DE SURVIE","UNE TROUSSE /DE SOINS","UN SAC A /DOS /ETANCHE","UN SPRAY /AU POIVRE","UNE /SERVIETTE /LARGE","UNE PAIRE /DE /CHAUSSURE","UNE PAIRE /DE /CLAQUETTES","UN GILET /DE SECURITE","UN /TROUSSEAU /DE CLES"};
        String[] presidents = {"Présidents","BARACK /OBAMA","DONALD /TRUMP","EMMANUEL /MACRON","FRANÇOIS /HOLLANDE","NICOLAS /SARKOZY","JACQUES /CHIRAC","FRANÇOIS /MITTERRAND","VALERY /GISCARD /D'ESTAING","CHARLES DE /GAULLE","RENE COTY","VINCENT /AURIOL","GEORGE /WALKER /BUSH","BILL /CLINTON","GEORGE /HERBERT /WALKER BUSH","RONALD /REAGAN","JIMMY /CARTER","GERALD /FORD","RICHARD /NIXON","JOHN /FITZGERALD / KENNEDY"};
