...
var Wheel = (function () {
    var wheel = document.getElementById('wheel'),
        wheelValues = [100, 350, 250, 100, 1000, "holdup", 150, 250, 500, "bankerupt", 1500, 150, 250, "passe", 400, 2000, 100, 0, 150, 250, 300, 150, 200, "bankrupt"],
        spinTimeout = false,
...
var WheelGame = (function () {
    var wheel = new Wheel(),
        vowels = ['A', 'E', 'I', 'O', 'U', 'Y'],
        wordDisplay,
        spinWheel = document.getElementById('tourner'),
        buyVowel = document.getElementById('voyelle'),
        newButton = document.getElementById('nouveau'),
        money = document.getElementById('montant');
    ...
    function WheelGame(puzzles) {
        ...
        bindEvent(buyVowel, "click", function () {
            if (_this.currentMoney > 200) {
                if (_this.createGuessPrompt("Entrer une voyelle", true) !== false) {
                    _this.currentMoney -= 200;
                    _this.updateMoney();
                }
            } else {
                alert("Tu as besoin de 300€ pour acheter une voyelle");
            }
        });
